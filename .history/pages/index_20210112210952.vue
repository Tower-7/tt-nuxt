    ...
    <el-row class="top">
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24"
        ><div class="grid-content bg-purple-dark">
          PICO CABINETS PICO CABINETS PICO CABINETS PICO CABINETS PICO CABINETS
          PICO CABINETS
        </div></el-col
      >
    </el-row>
    <el-row class="wrap">
      <el-col :xs="24" :sm="24" :md="22" :lg="22" :xl="20"
        ><div class="grid-content bg-purple-light">
          ...
          <tt-culmn></tt-culmn>
          <tt-product-list style="margin-top:30px"></tt-product-list>
          <tt-company-info style="margin-top:30px"></tt-company-info>
          <div class="footer" style="margin-bottom:50px"></div></div
      ></el-col>
    </el-row>
  </div>
</template>
